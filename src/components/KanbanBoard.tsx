...
export const KanbanBoard: React.FC = () => {
  ...
  const activitiesByStatus = useMemo(() => {
    const grouped = columns.reduce((acc, column) => {
      acc[column.id] = filteredActivities.filter(
        (activity) => activity.status === column.id
      );
      return acc;
  ...
  const handleViewActivity = (activity: Activity) => {
    setModalState({ isOpen: true, mode: 'view', activity });
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Button
            ...
            className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium px-6 py-3 rounded-lg shadow-lg transition-all duration-200 hover:shadow-xl"
          >
        ...
        <ActivityModal
          ...
          onClose={() => setModalState({ isOpen: false, mode: 'create', activity: null })}
